        ...
        if (errors && errors instanceof Error) {
            ...
            if (errors.stack) {
                if (process.env.NODE_ENV != 'production') {
                    ...
                    if (errors.traceOffset && errors.traceOffset > 0) {
                        errors.trace.splice(1, errors.traceOffset);
                    }
                    self.response.error = errors;
                }
                if (errors.traceOffset) {
                    delete errors.traceOffset;
                }
            }
        }
    }
...
Response.prototype.addPreviousLink = function(previousLink) {
    ...
    this.response.links.prev = previousLink;
}
